...
const AdProvider = ({ config, children }) => {
    ...
    return (jsx(AdContext.Provider, { value: { adService, isReady }, children: children }));
};
const useAd = () => {
...
const AdSlot = ({ slot, bidders = [], lazyLoad = false, refreshInterval, className, style, onLoad, onError }) => {
    ...
    return (jsx("div", { id: slot.id, className: className, style: {
...
export { AdProvider, AdService, AdSlot, BidderPresets, VERSION, useAd, useAdService };
